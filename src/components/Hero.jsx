  ...
  <section id='Home' className={`flex md:flex-row flex-col ${styles.paddingY} overflow-hidden`}>
    ...
    <div className={`${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        Our team of experts uses a methodology to identify the credit cardsmost likely to fit your needs. We examine annual percentage rates, annual fees.
      </p>
      
    </div>

    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      <img src={robot} alt="biiling" 
